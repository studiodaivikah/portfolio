...
import { Upload, Plus, Edit, Trash2, Save, X, FileText, Eye, Image as ImageIcon, Crop } from "lucide-react";
  ...
  return (
    <div className="max-w-6xl w-full mx-auto p-6 overflow-y-scroll">
      ...
      <ImageCropperModal
        ...
        title="Crop Portfolio Project Thumbnail Image"
        onClose={() =>
        ...
        onCropSave={async (croppedImageUrl) => {
          if (cropperModal.targetProject) {
            ...
            await updateProject(cropperModal.targetProject.id, {
              type: cropperModal.targetProject.type,
